...
## عن المشروع
دراية منصة تعليمية ذكية مصممة خصيصاً لطلاب عسر القراءة (Dyslexia) واضطراب تشتت الانتباه (ADHD).  
تأخذ أي نص أكاديمي عربي وتعيد بناءه بطريقة يفهمها عقل الطالب.
...
كما يعتمد النظام على الذكاء الاصطناعي من خلال Nuha 2.0.  
تم نشر الواجهة الأمامية عبر Vercel، في حين تم استضافة الخادم على Railway.
